package com.api_catalogo_livros.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.api_catalogo_livros.controller")) //local onde estão as controllers
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Api de Catalogo de  Livros Spring Boot REST API")
